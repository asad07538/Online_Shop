                        ...
                        <div class="card card-default">
                            ...
                            <div class="card-body">
                                        ...
                                        @foreach($cart_products as $product)
                                            <tr>
                                                ...
                                                <form action="{{ route('admin.cart.update', $product->rowId) }}" method="post">
                                                    ...
                                                    @method('PUT')
                                                    <td>
                                                        <input type="number" name="qty" class="form-control" value="{{ $product->qty }}" style="width: 80px">
                                                    </td>
                                ...
                                <div class="alert alert-info">
                                    ...
                                    <p>Sub Total : {{ Cart::subtotal() }} Rs</p>
                                   
                                </div>
                                <div class="alert alert-success">
                                    Total : {{ Cart::subtotal() }} Rs
                                </div>
                            </div>
                            <!-- /.card-body -->
                        </div>
                            ...
                            <div class="card-body">
                                <table id="example1" class="table table-bordered table-striped text-center table-responsive">
                                    ...
                                    <tr>
                                        ...
                                        <th class="p-1">Product Code</th>
                                        <th class="p-1">Add To Cart</th>
                                    </tr>
                                    </thead>
                                    <tfoot>
                                    <tr>
                                    ...
                                    @foreach($products as $key => $product)
                                        <tr>
                                            <form action="{{ route('admin.cart.store') }}" method="post">
                                                ...
                                                <input type="hidden" name="name" value="{{ $product->phone_model->name }}">
                                                ...
                                                <td>{{ strtoupper($product->phone_model->code) }}</td>
                                                <td>
