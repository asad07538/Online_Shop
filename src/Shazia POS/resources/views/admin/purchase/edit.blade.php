                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <select name="garage" class="form-control">
                                                    ...
                                                    <option value="A" {{ $product->garage == "A" ? 'selected' : '' }}>Shelf A</option>
                                                    <option value="B" {{ $product->garage == "B" ? 'selected' : '' }}>Shelf B</option>
                                                    <option value="C" {{ $product->garage == "C" ? 'selected' : '' }}>Shelf C</option>
                                                    <option value="D" {{ $product->garage == "D" ? 'selected' : '' }}>Shelf D</option>
                                                </select>
                                            </div>
                                            <div class="form-group col-md-4">
