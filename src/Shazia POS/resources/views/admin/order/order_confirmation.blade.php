                    ...
                    <div class="col-12">
                        ...
                        <div class="invoice p-3 mb-3">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <h4>
                                        <i class="fa fa-globe"></i>PARVI COMPUTERS
                            ...
                            <div class="row invoice-info">
                                <div class="col-sm-4 invoice-col">
                                    From
                                    <address>
                                        <strong>Admin,PARVI COMPUTERS</strong><br>
                                        {{ $company->address }}<br>
                                        {{ $company->city }} - {{ $company->zip_code }}, {{ $company->country }}<br>
                                        Phone: (+92) {{ $company->mobile }} {{ $company->phone !== null ? ', +92'.$company->phone : ''  }}<br>
                                        Email: {{ $company->email }}
                                    </address>
                                </div>
                                <!-- /.col -->
                                ...
                                <div class="col-sm-4 invoice-col">
                                    ...
                                    <address>
                                        ...
                                        Phone: (+92) {{ $order->customer->phone }}<br>
                                        ...
                                        <tbody>
                                            @foreach($order_details as $order_detail)
                                                <tr>
                                                    ...
                                                    <td>{{ $order_detail->product->phone_model->name }}</td>
                                                    <td>{{ $order_detail->product->phone_model->code }}</td>
                                ...
                                <div class="col-4 offset-4">
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tr>
                                                <th>Total:</th>
                                                <td class="text-right">{{ round($order->sub_total) }} Rs</td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
                            ...
                            <div class="row no-print">
                                <div class="col-12">
                                    ...
                                    @endif
                                    @if($order->order_status === 'approved')
                                        <a href="{{ route('admin.order.deliver', $order->id) }}" target="_blank" class="btn btn-primary float-right" style="margin-right: 5px;">
                                            <i class="fa fa-cart"></i> Deliver
                                        </a>
                                    @endif
